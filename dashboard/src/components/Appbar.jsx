...
const AppBar = () => {
  ...
  useEffect(() => {
    ...
    const storedUsername = localStorage.getItem('mt4_username');
  ...
  return (
    <div className={`sticky fixed top-[20px] left-0 right-0 z-50 flex flex-row mt-[20px] ${isLargeScreen ? 'ml-[10px] mr-[10px]' : 'ml-[10px] mr-[10px]'} h-[62.5px] px-6 bg-[#212525] rounded-[100px] text-white text-base leading-6 font-inter`}>
      {/* Logo Section */}
      ...
      {/* User Info and Actions (Visible on larger screens) */}
      <div className="hidden md:flex gap-3 justify-center items-center ml-4 text-base">
        ...
        {isLoggedIn ? (
          <div className="text-[#80ee64] font-medium px-4">
            {username || 'Welcome'}
          </div>
        ) : (
          <NavLink
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full top-[-5px] left-0 right-0 bg-[#212525] rounded-b-[50px] p-4">
          ...
          {isLoggedIn && (
            <div className="text-[#80ee64] font-medium py-2">
              {username || 'Welcome'}
            </div>
          )}
        </div>
...
//   return (
//     <div className="sticky fixed top-[20px] left-0 right-0 z-50 flex flex-row mt-[20px] ${isLargeScreen ? 'ml-[50px] mr-[50px]' : 'ml-[10px] mr-[10px]'} h-[62.5px] px-6 bg-[#212525] rounded-[100px] text-white text-base leading-6 font-inter">
//       {/* Logo Section */}
//       <div className="flex items-center">
//         <a
//           href="#"
